...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="{{ asset('front_template/plugins/bootstrap/bootstrap.min.css') }}">
    <!-- slick slider -->
    <link rel="stylesheet" href="{{ asset('front_template/plugins/slick/slick.css') }}">
    <!-- themefy-icon -->
    <link rel="stylesheet" href="{{ asset('front_template/plugins/themify-icons/themify-icons.css') }}">
    <!-- animation css -->
    <link rel="stylesheet" href="{{ asset('front_template/plugins/animate/animate.css') }}">
    <!-- aos -->
    <link rel="stylesheet" href="{{ asset('front_template/plugins/aos/aos.css') }}">
    <!-- venobox popup -->
    <link rel="stylesheet" href="{{ asset('front_template/plugins/venobox/venobox.css') }}">

    <!-- Main Stylesheet -->
    <link href="{{ asset('front_template/css/style.css') }}" rel="stylesheet">

    <!--Favicon-->
    <link rel="shortcut icon" href="{{ asset('front_template/images/favicon.ico')}}" type="image/x-icon">
    <link rel="icon" href="{{ asset('front_template/images/favicon.ico')}}" type="image/x-icon">
</head>
...
<body>
                    ...
                    <div class="col-lg-8 text-center text-lg-right">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><a
                                    ...
                                    href="{{ url('/student') }}">Dashboard</a></li>
                            @else
                            <li class="list-inline-item"><a
        ...
        <div class="navigation w-100">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <a class="navbar-brand" href="index.html"><img src="{{ asset('front_template/images/logo.png') }}"
                            alt="logo"></a>
    ...
    <!-- jQuery -->
    <script src="{{ asset('front_template/plugins/jQuery/jquery.min.js')}}"></script>
    <!-- Bootstrap JS -->
    <script src="{{ asset('front_template/plugins/bootstrap/bootstrap.min.js')}}"></script>
    <!-- slick slider -->
    <script src="{{ asset('front_template/plugins/slick/slick.min.js')}}"></script>
    <!-- aos -->
    <script src="{{ asset('front_template/plugins/aos/aos.js')}}"></script>
    <!-- venobox popup -->
    <script src="{{ asset('front_template/plugins/venobox/venobox.min.js')}}"></script>
    <!-- mixitup filter -->
    <script src="{{ asset('front_template/plugins/mixitup/mixitup.min.js')}}"></script>
    <!-- google map -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU&libraries=places">
    </script>
    <script src="{{ asset('front_template/plugins/google-map/gmap.js')}}"></script>

    <!-- Main Script -->
    <script src="{{ asset('front_template/js/script.js')}}"></script>
