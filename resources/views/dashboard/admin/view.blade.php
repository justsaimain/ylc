                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <form action="{{ route('dashboard.admin_delete' , $data->id) }}" method="POST"
                                            id="deleteAdmin{{ $data->id }}">
                                            @csrf
                                        </form>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('dashboard.admin_update' , $data->id) }}"
                                                    method="POST">
                                                    @csrf
                                                ...
                                                <p>Change Password</p>
                                                <form
                                                    action="{{ route('dashboard.admin_password_update' , $data->id) }}"
                                                    method="POST">
                                                    @csrf
